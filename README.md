...
- `docs/` — project proposal, [architecture](docs/ARCHITECTURE.md), [course project guide](docs/COURSE_PROJECT.md), [release checklist](docs/MVP_RELEASE.md), [deployment](docs/DEPLOYMENT.md), [benchmarks](docs/benchmarks/README.md)
